alter table users add column email_status char(2) null after allow_club_updates;
alter table user_audits add column email_status char(2) null after allow_club_updates;
