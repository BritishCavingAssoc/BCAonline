<div class="userAudits index">
    ...
    <h2><?php echo __('Report Of Group Members To Be Added'); ?></h2>
    <p>This reports lists the new group members to be added to the master file.</p>
    <h3><?php
        $line_count = count($addedLines);
        if ($line_count == 0) {
            echo "There are no group members to be added.";
        } elseif ($line_count == 1) {
            echo "There is 1 group member to be added.";
        } elseif ($line_count >= 250) {
            echo "There are more than 250 group members to be added.";
        } else {
            echo "There are $line_count group members to be added.";
        }
    ?></h3>
