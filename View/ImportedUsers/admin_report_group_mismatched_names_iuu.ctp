<div class="importedUsers form">
    ...
    <h2><?php echo __('Report of Mismatched Imported User Names vs Master Records for Group Members'); ?></h2>

    <p>This report shows the lines in the imported file which have different names in the master database for group members.</p>
    ...
    <?php for ($c1 = 0; $c1 < $line_count; $c1++) { ?>
        <tr>
        <td class="actions">
            <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete_group_mismatched_iuu', $mismatchedLines[$c1]['ImportedUser']['id']),
            null, __('Do you want to remove %s (%s) from the import?', $mismatchedLines[$c1]['ImportedUser']['organisation'],
            $mismatchedLines[$c1]['ImportedUser']['bca_no'])); ?>
        </td>
        <td>
        ...
        <td>
            ...
            $mismatchedLines[$c1]['ImportedUser']['forename'] . " " .
        ...
        <?php echo
            ...
            $mismatchedLines[$c1]['User']['forename'] . " " .
...
<div class="actions">
    ...
    <ul>
        <li><?php if ($line_count <> 0) {echo $this->Html->link(__('Send As Email'), array('action'=>'email_group_mismatched_names_iuu'));} ?> </li>
        <li><?php if ($line_count <> 0) {echo $this->Form->postLink(__('Tidy'), array('action' => 'tidy_group_mismatched_names_iuu'), null,
