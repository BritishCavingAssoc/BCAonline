<div class="importedUsers form">
	...
	<?php
		...
		echo $this->Form->input('insurance_status', array('options'=>array('C'=>'Caver', 'NC'=>'Non-Caver', 'STU'=>'Full Time Student',
            'U18'=>'Under 18', 'AN'=>'Another Route', 'Y'=>'Yes', 'N'=>'No'), 'empty'=>'Select'));
