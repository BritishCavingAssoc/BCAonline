<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('address4');?></th>
			<th><?php echo $this->Paginator->sort('address5');?></th>
			<th><?php echo $this->Paginator->sort('postcode');?></th>
			<th><?php echo $this->Paginator->sort('country');?></th>
			<th><?php echo $this->Paginator->sort('mobile');?></th>
			<th><?php echo $this->Paginator->sort('home_tel');?></th>
			<th><?php echo $this->Paginator->sort('studio_tel');?></th>
